...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tortoise Knight', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Life Enthusiast', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.tortoiseknight.top', // 网站地址
